...
const ACTION_LABELS: Record<string, string> = {
  ...
  'case.document.upload': 'Dokument hochgeladen',
  'case.task.add': 'Aufgabe angelegt',
  'case.task.done': 'Aufgabe erledigt',
  'doc.ocr.queue': 'OCR angestossen',
  'doc.translate.queue': 'Uebersetzung angestossen',
  'doc.review.done': 'DE-Fassung freigegeben',
