...
**Abkürzung:** ZO-Ärzte
**Ausfertigungsdatum:** 1957-05-28
**Stand:** Zuletzt geändert durch Art. 1 V v. 14.2.2025 I Nr. 40
...
(3) Diese Verordnung gilt für entsprechend.
...
(5) Soweit die Tätigkeit als Arzt im Praktikum wird diese auf die Weiterbildung nach Absatz 2 Buchstabe b bis zur Höchstdauer von insgesamt 18 Monaten angerechnet.
...
## Abschnitt IX: Vertreter, Assistenten, angestellte Ärzte und
...
(1) Für das Verfahren werden nachstehende Gebühren erhoben: Die Gebühren sind mit der Stellung des Antrags oder Einlegung des Widerspruchs fällig. Wird einem Widerspruch ganz oder teilweise stattgegeben, so wird die nach Buchstabe d entrichtete Gebühr zurückgezahlt.
